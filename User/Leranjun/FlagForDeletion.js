...
// <pre>
(() => {
    if ($(".will2Be2Deleted")[0] || mw.config.get("wgUserGroups").indexOf("patroller") === -1) return;

    const link = mw.util.addPortletLink("p-tb", "#", "挂删", "t-FlagForDeletion", "挂删本页[alt-shift-d]", "d");
